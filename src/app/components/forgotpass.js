          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className="email pb-9">
              <input
                ...
                name=""
                id=""
                className="outline-none w-[320px] border-b-2 pb-3"
                placeholder="Email"
                value={email}
            ...
            <div className="btn-signup">
              <button
                type="submit"
                className="bg-[#2395FF] w-[320px] py-2 rounded-lg text-white transition duration-300 ease-in-out transform hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring focus:border-blue-300"
              >
                Send
              </button>
              <p className="text-[16px] text-[#595959] text-center mt-4">
